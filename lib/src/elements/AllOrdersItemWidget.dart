...
class AllOrdersItemWidget extends StatefulWidget {
  final bool expanded;
  final Order order;
  final bool showDeliverOrPickOrder;

  AllOrdersItemWidget(
      {Key key, this.expanded, this.order, this.showDeliverOrPickOrder})
      : super(key: key);
...
class _OrderItemWidgetState extends State<AllOrdersItemWidget> {
  @override
      ...
      children: <Widget>[
        Column(
          ...
          children: <Widget>[
            ...
            //               arguments:
            //                   RouteArgument(id: widget.order.id, param: false));
            //         },
                    ...
                    actions: <Widget>[
                      ...
                      FlatButton(
                        ...
                        onPressed: () {
                          ...
                          pr.show();
                          pickOrder(widget.order).then((value) {
                            pr.hide();
                            if (value['status']) {
