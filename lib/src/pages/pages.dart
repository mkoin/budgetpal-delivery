...
import 'package:markets_deliveryboy/src/pages/all_orders.dart';
...
class _PagesTestWidgetState extends State<PagesTestWidget> {
  ...
  void _selectTab(int tabItem) {
    setState(() {
      widget.currentTab = tabItem == 4 ? 1 : tabItem;
      switch (tabItem) {
        case 0:
        ...
        case 3:
          ...
          break;
        case 4:
          widget.currentPage = AllOrdersWidget(parentScaffoldKey: widget.scaffoldKey);
          break;
      }
    });
  }
