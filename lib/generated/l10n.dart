...
class S {
  ...
  String get would_you_please_confirm_if_you_have_delivered_all_meals {
    return Intl.message(
      'Would you please confirm if you have delivered all meals to client by entering the delivery code below\n',
  ...
  String get confirm_delivery_to_client {
    return Intl.message(
      'Would you please confirm if you have delivered all meals to client by entering the delivery code below\n',
      name: 'confirm_delivery_to_client',
      desc: '',
      args: [],
    );
  }
